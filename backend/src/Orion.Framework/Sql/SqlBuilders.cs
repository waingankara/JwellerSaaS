...
public sealed class SearchBuilder
{
    ...
    public SqlStatement Build(MasterDefinition d, IReadOnlyList<Orion.Framework.Query.FilterDefinition> filters)
    {
