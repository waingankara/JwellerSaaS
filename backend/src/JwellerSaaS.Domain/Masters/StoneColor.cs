...
{
    [PrimaryKey]
    [DbColumn("stone_color_id")]
    public long StoneColorId { get; set; }
    ...
    [RequiredForInsert]
    [RequiredForUpdate]
    [DbColumn("stone_color_code")]
    public string StoneColorCode { get; set; } = string.Empty;
    ...
    [RequiredForInsert]
    [RequiredForUpdate]
    [DbColumn("stone_color_name")]
    public string StoneColorName { get; set; } = string.Empty;
